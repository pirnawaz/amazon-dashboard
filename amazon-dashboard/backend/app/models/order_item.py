...
class OrderItem(Base):
    ...
    source: Mapped[str | None] = mapped_column(Text, nullable=True, comment="e.g. spapi for SP-API bridged rows")
    source_order_item_id: Mapped[str | None] = mapped_column(Text, nullable=True, comment="Amazon OrderItemId for idempotency when source=spapi")
